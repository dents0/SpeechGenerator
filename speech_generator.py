...
part3 = ("play(s) an important role in shaping ", "require(s) an analysis of ",
         "require(s) definition and clarification of ",
         "contribute(s) to the preparation and implementation of ",
         "guarantees a wide range of specialists participation in the formation of ",
         "allow(s) us to perform important tasks to develop ",
         "give(s) us no choice but to define ", "compel(s) us to objectively demand ",
         "play(s) a decisive role for ", "identif(y/ies) an urgent need of ")
...
def generate_sentence():
    ...
    sentence = choice(part1) + choice(part2) + choice(part3) + choice(part4)
    return sentence
...
def create_docx():
 ...
 directory...\n")
        ...
        print(f"Done! Find the speech you have generated in file {file_name}.docx")
